...
static MenuDef menuDefView[] = {
    ...
    {
        _TRN("S&how Pages Continuously Vertically"),
...
static MenuDef menuDefCreateAnnotFromSelection[] = {
    ...
    { _TRN("Squ&are"), CmdCreateAnnotSquare, },
    { _TRN("C&ircle"), CmdCreateAnnotCircle, },
...
static MenuDef menuDefCreateAnnotUnderCursor[] = {
    ...
    { _TRN("S&quiggly"), CmdCreateAnnotSquiggly, },
