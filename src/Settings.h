...
static const FieldInfo gFileStateFields[] = {
    ...
    {offsetof(FileState, zoom), SettingType::String, (intptr_t)"fit width"},
...
static const FieldInfo gTabStateFields[] = {
    ...
    {offsetof(TabState, zoom), SettingType::String, (intptr_t)"fit width"},
...
static const StructInfo gGlobalPrefsInfo = {
    ...
    "nTitle\0InverseSearchCmdLine\0CacheDir\0LazyLoading\0MainWindowBackground\0NoHomeTab\0HomePageSortByFrequentlyRead\0ReloadModifiedDocuments\0RememberOpene"
